...
| **Mix. para ElasticNet** | O parâmetro de mistura Elastic Net, com 0<=l1_ratio<=1. l1_ratio=0 corresponde a penalidade L2, l1_ratio=1 a L1. |
| **Normalizar** | Se os regressores serão normalizados antes da regressão. |
...
| **Considerar intercepto** | Estimar, ou não o intercepto. |
| **Coeficientes positivos** | Força os coeficientes a serem positivos. |
