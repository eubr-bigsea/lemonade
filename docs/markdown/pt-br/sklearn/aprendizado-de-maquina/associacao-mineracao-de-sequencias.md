...
![Fluxo de Trabalho - Ler dados](/img/sklearn/aprendizado_de_maquina/associacao_mineracao_de_sequencias/image4.png)
...
![Tabela Mineração de sequẽncias](/img/sklearn/aprendizado_de_maquina/associacao_mineracao_de_sequencias/image1.png)

4. Execute o fluxo e visualize o resultado (i.e., as sequências com suas respectivas frequências):
![Tabela Resultado - parte 1](/img/sklearn/aprendizado_de_maquina/associacao_mineracao_de_sequencias/image2.png)
![Tabela Resultado - parte 2](/img/sklearn/aprendizado_de_maquina/associacao_mineracao_de_sequencias/image3.png)
