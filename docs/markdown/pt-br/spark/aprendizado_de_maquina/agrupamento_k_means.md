...
![Fluxo de trabalho - Ler dados](/docs/img/spark/aprendizado_de_maquina/agrupamento_k_means/image2.png)

1. Adicione uma base de dados por meio da operação [Ler dados][4].\
![Formulário Ler dados](/docs/img/spark/aprendizado_de_maquina/agrupamento_k_means/image4.png)
...
![Formulário K-Means](/docs/img/spark/aprendizado_de_maquina/agrupamento_k_means/image1.png)

3. Na operação [Tabela][5], não preencha nada. 

4. Execute o fluxo e visualize o resultado.
![Resultado](/docs/img/spark/aprendizado_de_maquina/agrupamento_k_means/image3.png)\
