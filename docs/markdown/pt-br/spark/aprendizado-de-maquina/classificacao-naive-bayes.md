...
![Fluxo de trabalho - Ler dados](/img/spark/aprendizado-de-maquina/classificacao-naive-bayes/image4.png)
...
![Formulário Naïve Bayes - parte 1](/img/spark/aprendizado-de-maquina/classificacao-naive-bayes/image1.png)
![Formulário Naïve Bayes - parte 1](/img/spark/aprendizado-de-maquina/classificacao-naive-bayes/image2.png)
...
![Resultado - Gráfico](/img/spark/aprendizado-de-maquina/classificacao-naive-bayes/image3.png)
![Resultado - Tabela](/img/spark/aprendizado-de-maquina/classificacao-naive-bayes/image5.png)
