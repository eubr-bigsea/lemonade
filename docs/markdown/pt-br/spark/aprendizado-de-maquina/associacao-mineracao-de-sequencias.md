...
![Fluxo de Trabalho - Ler dados](/img/spark/aprendizado-de-maquina/associacao-mineracao-de-sequencias/image4.png)
...
![Tabela Mineração de sequẽncias](/img/spark/aprendizado-de-maquina/associacao-mineracao-de-sequencias/image1.png)

4. Execute o fluxo e visualize o resultado (i.e., as sequências com suas respectivas frequências):
![Tabela Resultado - parte 1](/img/spark/aprendizado-de-maquina/associacao-mineracao-de-sequencias/image2.png)
![Tabela Resultado - parte 2](/img/spark/aprendizado-de-maquina/associacao-mineracao-de-sequencias/image3.png)
