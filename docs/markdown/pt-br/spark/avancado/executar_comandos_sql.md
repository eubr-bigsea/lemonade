...
![Ler dados](/lemonade/img/spark/avancado/executar_comandos_sql/image3.png)\
...
2. Utilize operação **Executar Consulta SQL** para juntar as duas bases e preencha o campo com a consulta desejada.
    ...
    **Consulta: Selecionar os atributos A, B e key**.\
	...
	![Consultar](/lemonade/img/spark/avancado/executar_comandos_sql/image1.png)
...
3. Execute e visualize o resultado obtido.\\
	...
	![Resultado](/lemonade/img/spark/avancado/executar_comandos_sql/image2.png)
