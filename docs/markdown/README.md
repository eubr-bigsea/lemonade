# ![Logo](/docs/img/logo.png) LEMONADE
...
<div style="margin-top: 32px;width: 100%; text-align: center"><a style="" href="https://www.atmosphere-eubrazil.eu/" title="Atmosphere"><img src="/docs/img/atmosphere.png" alt="Atmosphere"></a></div>

<div style="width: 100%; text-align: center">
	<a style="" href="https://www.atmosphere-eubrazil.eu/" title="EUBRA BIGSEA"><img style="margin-top: 32px;max-width: 200px;" src="/docs/img/bigsea.png" alt="EUBRA BIGSEA"></a>
	<a style="margin: 0 64px;" href="https://www.atmosphere-eubrazil.eu/" title="Inweb"><img style="margin-top: 32px; max-width: 200px;" src="/docs/img/inweb.png" alt="Inweb"></a>
	<a href="https://www.atmosphere-eubrazil.eu/" title="CTIC"><img style="margin-top: 32px; max-width: 200px;" src="/docs/img/ctic.png" alt="CTIC"></a>
</div>

<div style="width: 100%; text-align: center">
	<a style="" href="https://www.atmosphere-eubrazil.eu/" title="RNP"><img style="margin-top: 32px;max-width: 200px;" src="/docs/img/rnp.png" alt="RNP"></a>
	<a style="margin: 0 64px;" href="https://www.atmosphere-eubrazil.eu/" title="CEWEB"><img style="margin-top: 32px; max-width: 200px;" src="/docs/img/ceweb.png" alt="CEWEB"></a>
	<a href="https://www.atmosphere-eubrazil.eu/" title="NICBR"><img style="margin-top: 32px; max-width: 200px;" src="/docs/img/nic.png" alt="NICBR"></a>
</div>

<div style="width: 100%; text-align: center">
	<a href="https://www.atmosphere-eubrazil.eu/" title="CNPq"><img style="margin-top: 32px;max-width: 200px;" src="/docs/img/cnpq.png" alt="CNPq"></a>
	<a style="margin: 0 64px;" href="https://www.atmosphere-eubrazil.eu/" title="CAPES"><img style="margin-top: 32px; max-width: 200px;" src="/docs/img/capes.png" alt="CAPES"></a>
	<a href="https://www.atmosphere-eubrazil.eu/" title="FAPEMIG"><img style="margin-top: 32px; max-width: 200px;" src="/docs/img/fapemig.png" alt="FAPEMIG"></a>
</div>