					...
					'/pt-br/sklearn/': [
						...
						},
						{
                            ...
                            children: [
                                ...
                                ['aprendizado-de-maquina/regressor-huber.md', 'Regressão - Huber'],
                                ['aprendizado-de-maquina/regressor-perceptron-multicamadas.md', 'Regressão - Perceptron Multicamadas'],
                                ['aprendizado-de-maquina/regressor-sgd.md', 'Regressão - SGD'],
                                ...
                                ['aprendizado-de-maquina/classificacao-perceptron.md', 'Classificação - Perceptron'],
