...
- Mensalmente (#1): é permitida a seleção dos meses em que o processo será disparado (#4) e, também, indicar qual é o dia do mês (#2) e a hora (#3) em que a execução deverá ocorrer;
